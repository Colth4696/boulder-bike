...
class RacersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create racer" do
    assert_difference('Racer.count') do
      post racers_url, params: { racer: { city: @racer.city, first_name: @racer.first_name, last_name: @racer.last_name, state: @racer.state } }
    end
  ...
  test "should update racer" do
    patch racer_url(@racer), params: { racer: { city: @racer.city, first_name: @racer.first_name, last_name: @racer.last_name, state: @racer.state } }
